# RailsAdmin config file. Generated on November 11, 2011 09:28
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Nspeed', 'Admin']
  ...
  # config.excluded_models = [Company, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Company, User]
  ...
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime 
  #     field :company_id, :integer         # Hidden 
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
